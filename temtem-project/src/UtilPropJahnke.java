...
public class UtilPropJahnke {
   ...
   static String _PROP_FILENAME_OSX_LOCAL = "/Users/Ben/Documents/Software_Engineering/TemTem/TemTem/temtem-project/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/temtem-project/config.properties";
